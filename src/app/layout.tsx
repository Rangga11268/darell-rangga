...
export const metadata: Metadata = {
  ...
  description:
    "Darell Rangga adalah Web Developer Indonesia spesialis React, Next.js, dan Laravel. Membangun website modern, cepat, dan profesional untuk bisnis dan personal.",
  keywords: [
    "Darell Rangga",
    "Rangga",
  ...
  openGraph: {
    title: "Darell Rangga | Web Developer Indonesia",
    description:
      "Portfolio Darell Rangga - Web Developer Indonesia. Spesialisasi React, Next.js, dan Laravel. Tersedia untuk project freelance dan kolaborasi.",
